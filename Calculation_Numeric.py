...
'''
This program solves a reduced cubic eqaation such as s**3 + px = q(x) = 0 where we supply the parameters
for p and q. We sue a lambda function within a lambda function to do this
'''
